...
class _BoqScreenState extends State<BoqScreen> {
  ...
  // F-G50: render money with Indian lakh/crore grouping (en_IN locale) so the
  // numbers match what the server invoice PDF shows. The default
  // NumberFormat.currency uses Western grouping (1,000,000 instead of 10,00,000).
