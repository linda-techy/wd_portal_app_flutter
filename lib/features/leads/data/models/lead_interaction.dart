...
class LeadInteraction {
  ...
  final String
      interactionType; // CALL, EMAIL, MEETING, SITE_VISIT, WHATSAPP, OTHER
  ...
  final String? notes;
  final String?
      outcome; // SCHEDULED_FOLLOWUP, QUOTE_SENT, NEEDS_INFO, NOT_INTERESTED, CONVERTED, OTHER
  ...
  factory LeadInteraction.fromJson(Map<String, dynamic> json) =>
      _$LeadInteractionFromJson(json);
